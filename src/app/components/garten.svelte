<svg class="w-6 sm:w-8 h-6 sm:h-8 group transition duration-700 hover:-rotate-180 ease-in-out" width="416" height="416" viewBox="0 0 416 416" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <mask id="path-5-inside-2_670_44654" fill="white">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M16 226C16 322.098 93.9025 400 190 400L190 226L16 226Z" />
  </mask>
  <path d="M190 400L190 418L208 418L208 400L190 400ZM16 226L16 208L-2 208L-2 226L16 226ZM190 226L208 226L208 208L190 208L190 226ZM190 382C103.844 382 34 312.156 34 226L-2 226C-2 332.039 83.9613 418 190 418L190 382ZM172 226L172 400L208 400L208 226L172 226ZM16 244L190 244L190 208L16 208L16 244Z" fill="#6b7280" mask="url(#path-5-inside-2_670_44654)" />
</svg>
